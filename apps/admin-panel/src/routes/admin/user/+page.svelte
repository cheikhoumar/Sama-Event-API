...
<div class="p-4">
	...
	<div class="items-center justify-between lg:flex">
		<div class="mb-3 lg:mb-0">
			<Heading tag="h2" class="mb-3">Gestion des utilisateurs</Heading>
...
<Table striped>
	<TableHead>
		...
		<TableHeadCell padding="px-2">Nom d'utilisateur</TableHeadCell>
		<TableHeadCell>Nom complet</TableHeadCell>
		<TableHeadCell>Email</TableHeadCell>
		<TableHeadCell padding="px-0">Activé?</TableHeadCell>
		<TableHeadCell>Groupes</TableHeadCell>
		<TableHeadCell padding="px-2">Emplacement</TableHeadCell>
	...
	<TableBody>
		...
		{:else}
			<TableBodyRow>
				<td colspan="7">
					<div class="flex h-64">
						<span class="m-auto text-center text-xl font-bold">Pas trouvé</span>
					</div>
				</td>
			</TableBodyRow>
		{/if}
...
<Modal bind:open={formModal} size="xs" autoclose={false} class="w-full">
	<form class="flex flex-col space-y-6" action="?/edit" method="post">
		<h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Modifier les données de l'utilisateur</h3>
		...
		<div class="flex items-start">
			<Checkbox checked={formUser.activated} bind:group={a} value={'true'}>Activé</Checkbox>
			<input type="hidden" name="activated" value={activated} />
		</div>
		<Button type="submit" class="w-full">Soumettre</Button>
	</form>
</Modal>
