...
<div class="p-4">
	...
	<div class="max-w-screen-xl items-center justify-between lg:flex">
		<div class="mb-3 lg:mb-0">
			<Heading tag="h2" class="mb-3">Gestion des événements</Heading>
...
<Table striped>
	<TableHead>
		...
		<TableHeadCell padding="pl-0">Nom de l'événement</TableHeadCell>
	...
	<TableBody>
				...
				<TableBodyRow>
					...
					<TableBodyCell>
						...
						{:else if event.deletedAt}
							<Badge rounded border color="primary">SUPPRIMÉ</Badge>
						{:else}
		...
		{:else}
			<TableBodyRow>
				<td colspan="7">
					<div class="flex h-64">
						<span class="m-auto text-center text-xl font-bold">Non trouvé</span>
					</div>
				</td>
			</TableBodyRow>
		{/if}
