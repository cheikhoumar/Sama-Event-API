...
<div class="px-4 pt-6">
		...
		<div class="flex w-full flex-col gap-4">
			<Card size="xl">
				<div class="flex justify-between border-b border-gray-200 pb-3 dark:border-gray-700">
					...
					<div>
						...
						>
						Frais de retrait: {defaultCurrencyFormatter.format(data.withdrawFee.amount)}
						</span>
					</div>
				</div>
			...
			<div class="grid grid-cols-2 gap-4 2xl:grid-cols-1">
				<Card horizontal>
					<div class="w-full">
						<h3 class="text-base font-normal text-gray-500 dark:text-gray-400">
							Total des achats effectués: {`${data.purchasesCount ?? 0}`}
						</h3>
						<span
				...
				<Card horizontal>
					<div class="w-full">
						<h3 class="text-base font-normal text-gray-500 dark:text-gray-400">
							Total des achats remboursés: {`${data.refundedPurchasesCount ?? 0}`}
						</h3>
						<span
	...
	<div class="mt-4 grid w-full grid-cols-2 gap-4 xl:grid-cols-4">
		<Card horizontal>
			<div class="w-full">
				<h3 class="text-base font-normal text-gray-500 dark:text-gray-400">Événement publié</h3>
		...
		<Card horizontal>
			<div class="w-full">
				<h3 class="text-base font-normal text-gray-500 dark:text-gray-400">Projet d'événement</h3>
				<span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">
		...
		<Card horizontal>
			<div class="w-full">
				<h3 class="text-base font-normal text-gray-500 dark:text-gray-400">Événement rejeté</h3>
		...
		<Card horizontal>
			<div class="w-full">
				<h3 class="text-base font-normal text-gray-500 dark:text-gray-400">Nombre d'utilisateurs activés</h3>
				<span class="text-2xl font-bold leading-none text-gray-900 sm:text-3xl dark:text-white">
					{data.userCount}
				</span>
			</div>
		...
		<Card size="xl">
			...
			<div class="items-center justify-between lg:flex">
				<div class="mb-4 lg:mb-0">
					<Heading tag="h3" class="mb-2">Dernier événement créé</Heading>
					<span class="text-base font-normal text-gray-500 dark:text-gray-400">
						Voici une liste des derniers événements
					</span>
				</div>
			</div>
			<!-- Table -->
				...
				<div class="overflow-x-auto rounded-lg">
					<div class="inline-block min-w-full align-middle">
						<div class="overflow-hidden shadow sm:rounded-lg">
							<Table striped>
								<TableHead>
									<TableHeadCell>Nom de l'événement</TableHeadCell>
									<TableHeadCell>Emplacement</TableHeadCell>
									<TableHeadCell>Propriétaire</TableHeadCell>
									<TableHeadCell>Date de l'événement</TableHeadCell>
									<TableHeadCell padding="px-0">Tickets vendus</TableHeadCell>
									<TableHeadCell padding="px-1">Revenu</TableHeadCell>
									...
									{#if data.recentEvents.length}
										{#each data.recentEvents as event}
											<TableBodyRow>
												...
												<TableBodyCell tdClass="px-1">
													<Button href="/admin/event/{event.id}" pill size="sm">Détails</Button>
												</TableBodyCell>
											</TableBodyRow>
										{/each}
									{:else}
										<TableBodyRow>
											<td colspan="7">
												<div class="flex h-64">
													<span class="m-auto text-center text-xl font-bold">Pas disponible</span>
												</div>
											</td>
										</TableBodyRow>
									{/if}
