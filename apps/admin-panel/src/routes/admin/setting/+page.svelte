...
<div class="p-4">
	...
	<Heading tag="h2" class="mb-3">Paramètres</Heading>
</div>

<form action="?/updateFee" method="post" class="m-4">
	<Heading tag="h3" id="withdrawalFee" class="mb-3">Frais de retrait</Heading>
	<div class="mb-4 grid gap-4 sm:grid-cols-2">
		<div>
			<Label for="fee" class="mb-2">Mise à jour des frais de retrait</Label>
...
<form class="m-4" method="post" action="?/updateMyProfile">
	<Heading tag="h3" id="updateMyProfile" class="mb-3">Mise à jour de mon Profile</Heading>
	<div class="mb-4 grid gap-4 sm:grid-cols-2">
		<div>
			<Label for="fullname" class="mb-2">Nom complet</Label>
			<Input
				type="text"
				id="fullname"
				name="fullname"
		...
		<div>
			<div class="mb-4">
				<Label for="location" class="mb-2">Emplacement</Label>
				<Input
					type="text"
					id="location"
					name="location"
		...
		<div>
			<div class="mb-4">
				<Label for="confirm_password" class="mb-2">Confirmer mot de passe</Label>
