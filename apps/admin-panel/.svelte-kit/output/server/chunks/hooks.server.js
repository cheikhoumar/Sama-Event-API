...
import { G as Group } from "./group.enum.js";
...
async function checkAccessToken({
  ...
  try {
    ...
    const claims = accessToken ? jwt.verify(accessToken, config.security.accessTokenKey, { ignoreExpiration: false }) : void 0;
...
async function checkRefreshToken({
  ...
  try {
    if (!event.locals.user) {
      ...
      const claims = refreshToken ? jwt.verify(refreshToken, config.security.refreshTokenKey) : void 0;
